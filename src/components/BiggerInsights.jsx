...
export default function RoadmapPhaseTwo() {
  ...
  return (
    <div className="min-h-screen bg-[#001a2c] relative overflow-hidden">
      ...
      <div className="absolute left-0 top-0 h-full w-1/2 z-0">
        <div className="absolute inset-0 bg-gradient-to-l from-[#001a2c] via-[#001a2c]/50 to-transparent z-10" />
        <img 
          src="https://th.bing.com/th/id/OIP.8bAFpuy_Hd-F9uGgoGcguQHaHa?rs=1&pid=ImgDetMain"
          alt="Night City" 
        ...
        <div className="w-full ml-auto text-right">  
          ...
          <div className="space-y-6">
            {[
              ...
              <div 
                key={index}
                className={`flex items-start gap-4 justify-end transition-all duration-500 ${
                  isVisible 
